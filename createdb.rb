...
events_table = DB.from(:blog)

blog_table.insert(title: "Multi-tasking with Uber + Lyft", 
                    description: "Driving with Uber and Lyft at the same time can be tricky, but many drivers find that it helps to maximize income when done right. Here are the best of the best tips we have seen from drivers who choose to use Uber and Lyft at the same time: 
...
blog_table.insert(title: "DJ or Driver?", 
                    description: "IHave you ever been jamming to music but a rider asks you turn it down? We’ve been there, too.  But it got us wondering, what is the best music to play for passengers during rides? We did some digging, and the answer might surprise you. 
